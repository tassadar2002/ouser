 ...
 * @author hanlixin
 */
public class SearchAppointProcess extends BaseProcess {

	private static final String URL = "http://app.zhengre.com/servlet/TabSearchServlet_Android_V2_0";
	...
	protected void onResult(String result) {
		try {
			...
			for(int i = 0; i < array.length(); ++i) {
				...
				appoint.getAppointId().setUid(json.optString("email"));
				appoint.setContent(UrlUtil.decode(json.optString("desirecontent")));
	...
	protected String getFakeResult() {
		return new GetJoinAppointProcess().getFakeResult();
	}
}
